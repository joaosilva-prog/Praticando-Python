...
Original file is located at
    https://colab.research.google.com/drive/1pm6ia_2Z_lz6c8FCeN4PMxd0d3DKgTCz
...
if qtd_macas > qtd_bananas:
  ...
  print("Houve empate no número de vendas.")
...
atvd_a = int(input("Informe os dias para a atividade A: "))
atvd_b = int(input("Informe os dias para a atividade B: "))
atvd_c = int(input("Informe os dias para a atividade C: "))

if atvd_a < 0 or atvd_b < 0 or atvd_c < 0:
  print("Erro: os dias não podem ser negativos.")
else:
  print(f"Total de dias do projeto: {atvd_a + atvd_b + atvd_c}")
...
temp_sala = int(input("Digite a temperatura atual: "))
...
distancia = int(input("Digite a distância percorrida (km): "))

if distancia <= 100:
  print("Valor do pedágio: R$ 10,00")
elif distancia <= 200:
  print("Valor do pedágio: R$ 20,0")
else:
  print("Valor do pedágio: R$ 30,0")
...
if renda <= 2000:
  print("Empréstimo negado: renda mínima insuficiente.")
